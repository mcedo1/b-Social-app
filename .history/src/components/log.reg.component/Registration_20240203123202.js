...
function Registration() {
    ...
    const [regMessage, regMessage] = useState('')
                        ...
                        <Card.Body>
                            ...
                            <Form>
                                ...
                                <Form.Group>
                                    ...
                                    <Form.Control type='password' id="password"  style={{borderColor:alerts.color}} value={user.passwordConf} onChange={e=>{setUser({...user, passwordConf: e.target.value})}}/>
                                </Form.Group>
