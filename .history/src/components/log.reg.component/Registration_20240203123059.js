...
function Registration() {
    ...
    const handlePassConf = () => {
        if (user.password !== user.passwordConf)
            setAlerts({...alerts, color: 'red'})
        else
            setAlerts({...alerts, color: undefined})
                        ...
                        <Card.Body>
                            ...
                            <Form>
                                ...
                                <Form.Group>
                                    ...
                                    <Form.Control type='password' id="password" value={user.password} onChange={e=> {setUser({...user, password:e.target.value}); handlePassConf() }}/>
                                    <Form.Label htmlFor="password">Password Conformation:</Form.Label>
                                    <Form.Control type='password' id="password"  style={{borderColor:alerts.color}} value={user.passwordConf} onChange={e=>{setUser({...user, passwordConf: e.target.value}); handlePassConf()}}/>
                                </Form.Group>
