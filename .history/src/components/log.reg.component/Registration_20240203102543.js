                        ...
                        <Card.Body>
                            ...
                            <Form>
                                ...
                                <Form.Group>
                                    ...
                                    <Form.Control type='password' id="password" value={user.password} style={{borderColor:'red', borderBlock:'2px solid red'}} onChange={e=> setUser({...user, password:e.target.value})}/>
                                </Form.Group>
