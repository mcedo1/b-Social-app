...
function Login() {
    ...
    const handleLogin = () => {
       ...
       api('/api/users/login', loginData, 'post').then(res=>{ console.log(res}))
    }
    return (
        <div className='Login'>
                    <Container>
                    ...
                    <Card>
                        <Card.Body>
                            <Card.Title>
                                ...
                                <Form>
                                        <Form.Group>
                                            <Form.Label htmlFor="email">Username(E-mail):</Form.Label>
                                            <Form.Control type='email' id="email" value={user.identity} onChange={e=> setUser({...user, identity:e.target.value})}/>
                                        </Form.Group>
                                        <Form.Group>
                                        ...
                                        <br/>
                                        <Form.Group>
                                            <Button variant='primary' style={{marginRight:'20px'}} onClick={handleLogin} >
                                                Sign In
                                            </Button>
                                            <Button variant='success' onClick={()=>navigate("/reg")} >
                                                Sign Up
                                            </Button>
                                        </Form.Group>
                                </Form>
